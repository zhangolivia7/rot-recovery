      ...
      <section id="sec1" className="h-screen flex justify-center items-center snap-start">
        <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
          <div id="s1">
            ...
            <svg width="1441" height="964" viewBox="0 0 1441 964" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M148.646 363.552C91.0762 438.396 0 867.5 0 867.5V964H1375H1440.5V905C1401.89 678.974 1336.02 197.758 1252.35 86.2438C1144.34 -57.7212 1031.61 10.6378 952.439 62.2496C904.639 93.4101 795.141 246.205 724.357 261.701C653.573 277.197 503.312 200.592 395.08 200.592C277.106 200.592 212.53 280.5 148.646 363.552Z" fill="#FFE1A8" />
            </svg>
          </div>
        </main>
      </section>
