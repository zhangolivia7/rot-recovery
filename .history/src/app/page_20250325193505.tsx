...
export default function Home() {
  ...
  const handleSubmit = async () => {
    ...
    if (name.toLowerCase() === "leslie") {
      ...
      00:00-00:30: Finish Math Homework, Leslie-chan! Take a deep breath and dive into your math problems. Focus on one question at a time, and make sure you understand each concept before moving on to the next. You got this!
