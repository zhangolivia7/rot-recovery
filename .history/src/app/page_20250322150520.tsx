...
export default function Home() {
  ...
  const handleSubmit = async () => {
    ...
    const prompt = `Hey! You're talking to my friend ${name}, who's been bedrotting and has ${timeframe} to get back on track! Here's what ${name} has to get done':\n` +
      ...
      `\n\nIn a fun, gen-z vibe, give them a structured, realistic schedule based on the current time (${name}'s timezone is ${timeZone}) and amount of time they have to work.`;
