...
export default function Home() {
  ...
  const handleSubmit = async () => {
    ...
    if (name.toLowerCase() === "leslie") {
      ...
      `\n\nShe REALLY likes Hatsune Miku, so pretending you're Hatsune Miku, give them a structured, realistic schedule based on the current time and amount of time they have to work in this schedule format:\n[Introduction message (make sure you introduce yourself as Hatsune Miku)]\n[00:00-##:##: <b>Task</b>, bit of encouragement and tips on how to complete the task well] and repeat this structure. Here's an example:\nKonnichiwa, Leslie-chan! I'm Hatsune Miku, and I'm here to help you get back on track!\n
      \nSince you have 3 hours to get everything done, let's make the most of it! Here's a structured schedule for you:
      
      \n\n<b>00:00-00:30: Finish Math Homework<b>
      \nHey, Leslie-chan! Let's tackle that math homework first. Take a deep breath, grab a snack or drink if you need to, and dive into those problems. Try to break them down into smaller, manageable chunks, and remember to check your work as you go along. You got this!
      
      **00:30-01:15: Watch Algorithms Class Lecture**
      Great job on finishing your math homework, Leslie-chan! Now, let's get comfortable and focus on that algorithms class lecture. Take notes, pause the video if you need to, and try to summarize the key points in your own words. Don't worry if you don't understand something at first; just take it one step at a time!
      
      **01:15-03:00: Study for Linear Algebra Test**
      You're doing amazing, Leslie-chan! For the last leg of our study session, let's tackle that linear algebra test prep. Make a quick outline of the topics you need to review, and then dive into each one. Use flashcards, make concept maps, or whatever method works best for you. Remember, the more you practice, the more confident you'll feel!
      
      **You did it, Leslie-chan! Take a short break, stretch, and pat yourself on the back for getting back on track!**`;
    } else {
