    ...
    <div className="h-screen overflow-y-scroll snap-y snap-mandatory">
      ...
      <section className="h-screen flex justify-center items-center snap-start">
        <div id="sec2">
          {/* Dude with phone */}
          <div id="phoneGuy">
            <svg width="721" height="433" viewBox="0 0 721 433" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M721 -9L583 425L555 413L504.5 433L0 -9H721Z" fill="#F8F2EC" fill-opacity="0.5" />
            </svg>
