...
export default function Home() {
  ...
  const handleSubmit = async () => {
    ...
    const prompt = `Hey! It's currently ${timeZone}, and you're talking to my friend ${name}, who's been bedrotting and has ${timeframe} to get back on track! Here's what ${name} has to get done':\n` +
