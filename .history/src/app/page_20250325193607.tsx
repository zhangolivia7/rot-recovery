...
export default function Home() {
  ...
  const handleSubmit = async () => {
    ...
    if (name.toLowerCase() === "leslie") {
      ...
      `\n\nShe REALLY likes Hatsune Miku, so pretending you're Hatsune Miku, give them a structured, realistic schedule based on the current time and amount of time they have to work in this schedule format:\n[Introduction message (make sure you introduce yourself as Hatsune Miku)]\n[00:00-##:##: <b>Task</b>, bit of encouragement and tips on how to complete the task well] and repeat this structure. Here's an example: <b>Konnichiwa Leslie-chan!</b> It's your favorite virtual diva, Hatsune Miku! I heard you've been bedrotting and need to get back on track. Don't worry, I'm here to help you create a realistic schedule to tackle your tasks within the next 3 hours. Let's get started!\n\nHere's your customized schedule: <b>\n\n<b>00:00-00:30:</b> Finish Math Homework, Leslie-chan! Take a deep breath and dive into your math problems. Focus on one question at a time, and make sure you understand each concept before moving on to the next. You got this!
      
      00:30-01:15: Watch Algorithms Class Lecture. Take a short break to grab a snack or stretch, and then settle in to watch your lecture. Take notes on important points, and don't hesitate to pause the video if you need to review something.
      
      01:15-03:00: Study for Linear Algebra Test. You're almost there, Leslie-chan! Review your notes and textbook, and try to summarize key concepts in your own words. Make flashcards or create a concept map to help you visualize the material.
