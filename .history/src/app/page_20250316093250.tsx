...
export default function Home() {
  ...
  const handleSubmit = async () => {
    ...
    const prompt = `I need a schedule to recover from procrastination. I have ${timeframe} to get back on track. Here are my tasks:\n` +
      tasks.map((task, index) => `${index + 1}. ${task.text}`).join("\n") +
      `\n\nPlease provide a structured, realistic schedule based on this timeframe.`;
      ...
      <section className="h-screen flex flex-col items-center justify-center snap-start">
        <div id="form">
          ...
          <button
            ...
            className="mt-4 p-2 rounded-md bg-blue-500 text-white"
          >
